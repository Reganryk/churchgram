...
@section('title', $userprofile->uname)
@section('content')
    ...
    <div class="churchgram-mainpanel">
      <div class="container">
          ...
          <div class="col-md-3 mg-t-20  mg-lg-t-0" style="top: 20px;">
            <div class="card card-connection btn-br">
              ...
              <div class="media-list">
                ...
                <div class="media">
                  <img src="{{ URL::to('/') }}/storage/churches/profilepics/{{ $userprofile->userprofile->propic}}" alt="">
            ...
            <div class="card card-people-list pd-25 mg-t-20 btn-br">
              <div class="churchgram-card-title">Groups by {{ $userprofile->uname }}</div>
              <div class="media-list">
       ...
       <div class="timeline">
            ...
            <div class="timeline-cover" style="background: url({{ URL::to('/') }}/storage/users/banners/{{ $userprofile->userprofile->banner}}) no-repeat; background-position: top; background-size: cover;">
            ...
            <div class="row">
              <div class="col-md-3" style="margin-bottom: 130px; margin-left: 40px;">
                <div class="profile-info" >
                  ...
                  <img src="{{ URL::to('/') }}/storage/users/profilepics/{{ $userprofile->userprofile->propic}}" alt="" class="img-responsive profile-photo" />

                  <h3 style="text-align: center; text-transform: capitalize;">{{ $userprofile->uname }}</h3>
       ...
       .hidden-cd {
         ...
         <div class="navbar-mobile hidden-cd" style="position: absolute;">
            ...
            <div class="profile-info">
              <img src="{{ URL::to('/') }}/storage/churches/profilepics/{{ $userprofile->userprofile->propic}}" alt="" class="img-responsive profile-photo" />
              <h4 style="color: #fff;">{{ $userprofile->name }}</h4>
            ...
            <div class="mobile-menu">
              ...
              <div style="padding: 5px;">
                 <button class="btn btn-danger " style="padding: 2px; margin-right: 5px; border-radius: 8px;">999 Twins</button>
               <button class="btn btn-primary btn-sm" style="padding: 2px; margin-right: 5px; border-radius: 8px;">Twin Church</button>
              <button class="btn btn-primary btn-sm" style="padding: 2px; margin-right: 5px; border-radius: 8px;">Listen In <i class="fa fa-play"></i></button>
          </div>
            </div>
 ...
 <div class="card card-profile" style="padding: 10px;">
              <div class="card-body">
                ...
                @if(count($userprofile->card))
                <ol class="carousel-indicators">
                  <?php $x = 0; ?>
                      @foreach($userprofile->card as $card)
                      @if ($x == 0)
                ...
                @else
                 <div class="media-body">
                    ...
                    <p class="mg-b-0" style="height: 100px">Cards help us post our daily life. They help other people get to know who your. Lets me hope {{ $userprofile->uname }} will think about posting one </p><br>
                ...
                <div class="media-body">
                    <h3 class="card-profile-name" style="text-transform: capitalize;">{{ $userprofile->fname }}&nbsp;{{$userprofile->lname }}</h3>
                    <p class="card-profile-position">Currently attends: <a href="https://deepcodeplus.com">{{ $userprofile->church->name }}</a></p>
                    <p class="card-profile-position">Lives Around : {{ $userprofile->city }}&nbsp;{{ $userprofile->country }}</p>

                    <p class="mg-b-0" style="height: 100px">{{ $userprofile->userprofile->about }}</p><br>
...
@if(count($userprofile->post))
@foreach($userprofile->post->sortByDesc('updated_at') as $post)
