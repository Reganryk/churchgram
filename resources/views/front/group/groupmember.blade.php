      ...
      <div class="container">
       ...
       .hidden-xs {
         ...
         <div class="navbar-mobile hidden-cd" style="position: absolute;">
            ...
            <div class="profile-info">
              <img src="{{ URL::to('/') }}/storage/churches/profilepics/{{ $groupadmin->propic}}" alt="" class="img-responsive profile-photo" />
              <h4 style="color: #fff;">{{ $groupadmin->name }}</h4>
...
<a href="" class="nav-link"><i class="icon ion-arrow-shrink"></i>Report Post</a>
       ...
       .hidden-cd {
         ...
         <div class="navbar-mobile hidden-cd" style="position: absolute;">
          ...
          </div><!--Timeline Menu for Small Screens End--><br>
