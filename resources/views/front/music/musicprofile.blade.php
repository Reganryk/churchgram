...
<div class="col-md-11">
       <div class="timeline">
            ...
            <div class="timeline-cover" style="background: url({{ URL::to('/') }}/storage/music/banners/{{ $music->musicprofile->banner}}) no-repeat; background-position: top; background-size: cover;">
            ...
            <div class="row">
              <div class="col-md-5" style="margin-bottom: 130px; margin-left: 40px;">
                <div class="profile-info" >
                  ...
                  <img src="{{ URL::to('/') }}/storage/music/profilepics/{{ $music->musicprofile->propic}}" alt="" class="img-responsive profile-photo" />

                  <h3 style="text-align: center; text-transform: capitalize;">{{ $music->name }}</h3>
             ...
             <ul class="list-inline profile-menu">
                ...
                <ul class="follow-me list-inline" style="display: flex;">
                	...
                	<li style="margin-top: 5px;"> <button class="btn btn-warning btn-sm" style="padding: 5px; margin-right: 5px; border-radius: 8px;">Twin music</button></li>
        ...
        <style type="text/css">
         ...
         <div class="navbar-mobile hidden-cd" style="position: absolute;">
            ...
            <div class="profile-info">
              <img src="{{ URL::to('/') }}/storage/music/profilepics/{{ $music->musicprofile->propic}}" alt="" class="img-responsive profile-photo" />
              <h4 style="color: #fff;">{{ $music->name }}</h4>

            </div>
            <div class="mobile-menu">
              <ul class="list-inline" style="display: inline-flex; margin-bottom: 5px;">
                <li><a href="musictimeline.php" class="active">Timeline</a></li>
                <li><a href="musictimeline-about.php">About</a></li>
                <li><a href="musictimeline-album.php">Album</a></li>
                <li><a href="musictimeline-friends.php">Friends</a></li>
              </ul><br>
              <div style="padding: 5px;">
              	 <button class="btn btn-danger " style="padding: 5px; margin-right: 5px; border-radius: 8px;">999 Twins</button>
               <button class="btn btn-primary btn-sm" style="padding: 5px; margin-right: 5px; border-radius: 8px;">Twin music</button>
        ...
        <div class="row row-sm">
                ...
                <div class="carousel-inner" role="listbox">
                 ...
                 <a href="#createcard" data-toggle="modal" data-target="#createcard" class="btn btn-primary btn-teal btn-block">Create Card</a>
                  ...
                  <div class="media-body">
                    ...
                    <p class="card-profile-position">Currently attends: <a href="https://deepcodeplus.com">{{ Auth::user()->umusic }}</a></p>
          ...
          <div class="section-wrapper mg-t-20">
            ...
            <div class="card card-latest-activity mg-t-20">
              <div class="card-body">
                <div class="musicgram-card-title">Latest Posts By You</div>
          ...
          <div class="col-lg-4 mg-t-20 mg-lg-t-0">
            <div class="card card-connection">
              ...
              <div class="musicgram-card-title">music Upcoming Events</div>
              <div class="media-list">
              	<div class="scrollbarright" id="mainscroll1" style="padding: 4px;">
                <div class="media">
                  <img src="{{ URL::to('/') }}/storage/musices/profilepics/{{ $music->musicprofile->propic}}" alt="">
                  <div class="media-body">
                    <a href="">Praise and Worship Overnight </a>
                    <p><span style="color: #6F42C1">music Premises</span> at <span>Thur 04 2020 | 8:00pm</span></p>
                  </div><!-- media-body -->
            ...
            <div class="card card-people-list pd-25 mg-t-20">
              <div class="musicgram-card-title">Groups by {{ $music->uname }}</div>
              <div class="media-list">
              ...
              <div class="media">
                  ...
                  <div class="media-body">
                   ...
                   <div class="card card-people-list pd-25 mg-t-20">
              <div class="musicgram-card-title">Active Donations by {{ $music->uname }}</div>
              <div class="media-list">
              	<div class="scrollbarright" id="mainscroll" style="padding: 2px;">
                     <div class="media">
                  <img src="{{ URL::to('/') }}/storage/musices/profilepics/{{ $music->musicprofile->propic}}" alt="">
            ...
            <div class="card pd-25 mg-t-20">
              <div class="musicgram-card-title">Contact &amp; Personal Info</div>
