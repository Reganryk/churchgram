    ...
    <div class="d-md-flex flex-row">
       ...
       <div class="signin-left">
        <div class="signin-box">
          ...
          <p style="font-size: 18px; color: #fff;">Trying to register a church upgrades your Account Automatically. Therefore we will need upgraded information and  credentials so that we can be able to trust you with information of your Users</p>
          ...
          <p><a href="/churchgram/newsfeed.php" class=" pd-x-25"><i class="icon ion-reply"></i>I would like to cancel</a></p>

          <p class="tx-12" style="color: #fff;">Churchgram Team  ©  2019 - <script>document.write(new Date().getFullYear());</script>. All rights reserved</p>
        </div>
      </div><!-- signin-left -->
      <div class="signin-right">
        ...
        <div class="signin-box signup">
         ...
         <form action="{{ route('usercreatechurch1')}}" method="Post" >
          @csrf
            <div class="row row-xs mg-b-10">
            <div class="col-sm"><input type="text" maxlength="50" class="form-control" name="name" data-toggle="tooltip-primary" data-placement="top" title="Make the Name Short and Simple. For any Longer names you can Abbreviate them" placeholder="Church Name"></div>
          ...
          <div class="row row-xs mg-b-10">
            ...
            <div class="col-sm mg-t-10 mg-sm-t-0"><input name="password" type="password" class="form-control" data-toggle="tooltip-primary" data-placement="top" title="You will Require this Password every time you try to access the Church Dashboard" placeholder="Password"></div>
          </div><!-- row -->
