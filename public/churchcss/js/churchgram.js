$(function(){
  ...
  $('#churchgramSidebarMenu').on('click', function(e){
    e.preventDefault();
  ...
  if($.fn.perfectScrollbar) {
    $('.churchgram-sidebar').perfectScrollbar({
  ...
  $.get('../settings.html', function(data){
      ...
      if(isRtl) {
        $('.churchgram-direction[value="rtl"]').prop('checked', true);
      } else {
        $('.churchgram-direction[value="ltr"]').prop('checked', true);
      }
      ...
      if($.cookie('sticky-header')) {
        $('body').addClass('churchgram-sticky-header');
      ...
      if($.cookie('header-skin')) {
        ...
        $('body').addClass(sk);
        $('#headerSkin').attr('href',  '../css/churchgram.'+sk+'.css');
      ...
      if($.cookie('full-width')) {
        $('body').addClass('churchgram-full-width');
      ...
      if($.cookie('sticky-sidebar') && $('.churchgram-sidebar').length) {
        $('body').addClass('churchgram-sticky-sidebar');
  ...
  $('body').on('click', '.churchgram-direction', function(){
    var val = $(this).val();
  ...
  $('body').on('click', '.sticky-header', function(){
    ...
    if(val === 'yes') {
      ...
      $('body').removeClass('churchgram-sticky-header');
    }
  });

  // toggles sidebar to sticky
  $('body').on('click', '.sticky-sidebar', function(){
    if($('.churchgram-sidebar').length) {
      var val = $(this).val();
      if(val === 'yes') {
        ...
        $('body').removeClass('churchgram-sticky-sidebar');
      }
    } else {
  ...
  $('body').on('click', '.header-skin', function(){
    ...
    if(val !== 'default') {
      ...
      $('#headerSkin').attr('href','../css/churchgram.'+val+'.css');
    } else {
  ...
  $('body').on('click', '.full-width', function(){
    ...
    if(val === 'yes') {
      ...
      $('body').removeClass('churchgram-full-width');
    }
  });
