...
var Editor = /** @class */ (function () {
    function Editor(context) {
        ...
        this.insertNode = this.wrapCommand(function (node) {
            if (_this.ichurchgramited($$1(node).text().length)) {
                return;
            }
        ...
        this.insertText = this.wrapCommand(function (text) {
            if (_this.ichurchgramited(text.length)) {
                return;
            }
            var rng = _this.createRange();
        ...
        this.pasteHTML = this.wrapCommand(function (markup) {
            if (_this.ichurchgramited(markup.length)) {
                return;
            }
    ...
    Editor.prototype.initialize = function () {
        ...
        this.$editable.on('keydown', function (event) {
            ...
            if (_this.ichurchgramited(1, event)) {
                return false;
            }
    ...
    Editor.prototype.ichurchgramited = function (pad, event) {
        pad = pad || 0;
    ...
    Editor.prototype.tab = function () {
        ...
        if (rng.isCollapsed() && rng.isOnCell()) {
            ...
            if (!this.ichurchgramited(this.options.tabSize)) {
                this.beforeCommand();
